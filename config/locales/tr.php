...
"home" => [
  ...
  "solutions" => [
    ...
    "structural_cabling" => "Yapısal Kablolama Çözümleri",
    "structural_cabling_content" => "Yapısal Kablolama Çözümleri",

    "fiber_optic_infrastructure" => "Fiber Optik Alt Yapı Çözümleri",
    "fiber_optic_infrastructure_content" => "Fiber Optik Alt Yapı Çözümleri",

    "network" => "Ağ Çözümleri",
    "network_content" => "Ağ Çözümleri",

    "data_center" => "Data Center Çözümleri",
    "data_center_content" => "Data Center Çözümleri",

    "server" => "Sunucu Çözümleri",
    "server_content" => "Sunucu Çözümleri",

    "security" => [
      "link" => "Güvenlik Çözümleri",
      ...
      "video_conference" => "Video Konferans Çözümleri",
      "video_conference_content" => "Video Konferans Çözümleri",
