...
<div id="site-menu">
	...
	<div class="panel list-group">
		<a class="list-group-item" data-toggle="collapse" data-target="#notices" data-parent="#site-menu">
			...
			<i class="fa fa-bullhorn fa-3x visible-sm visible-xs"></i>
		</a>
	...
	<div class="panel list-group">
		<a class="list-group-item" data-toggle="collapse" data-target="#slides" data-parent="#site-menu">
			...
			<i class="fa fa-arrows-h fa-3x visible-sm visible-xs"></i>
		</a>
	...
	<div class="panel list-group">
		<a class="list-group-item" data-toggle="collapse" data-target="#galleries" data-parent="#site-menu">
			...
			<i class="fa fa-film fa-3x visible-sm visible-xs"></i>
		</a>
	...
	<div class="panel list-group">
		<a class="list-group-item" data-toggle="collapse" data-target="#partners" data-parent="#site-menu">
			...
			<i class="fa fa-briefcase fa-3x visible-sm visible-xs"></i>
		</a>
	...
	<div class="panel list-group">
		<a class="list-group-item" data-toggle="collapse" data-target="#references" data-parent="#site-menu">
			...
			<i class="fa fa-handshake-o fa-3x visible-sm visible-xs"></i>
		</a>
