<h4 class="page-title">Galleri Ekle</h4>

<form class="form-horizontal" action="/admin/galleries/save" accept-charset="UTF-8" method="post" enctype="multipart/form-data">
