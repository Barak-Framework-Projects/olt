<h4 class="page-title">Galeri Bilgileri</h4>

<div class="form-horizontal">
  <div class="form-group">
    <label class="col-sm-1 control-label" for="name">Ad</label>
    <div class="col-sm-11">
      <input type="text" value="<?= $gallery->name; ?>" class="form-control" name="name" id="name" disabled />
    </div>
  </div>
  <div class="form-group">
...
<form class="form-horizontal" action="/admin/galleries/destroy" method="post">
  <input type="hidden" value="<?= $gallery->id; ?>" id="id" name="id" />
  <div class="form-group">
    <div class="col-sm-offset-1 col-sm-11">
      <a class="btn btn-primary" href="/admin/galleries/edit/<?= $gallery->id; ?>">Düzenle</a>
