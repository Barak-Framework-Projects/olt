...
<iframe src="<?= Setting::unique(["name" => "site_address_maps"])->value; ?>" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<div class="text-center">
  ...
  <p><i class="fa fa-home"></i> <a href="http://<?= Setting::unique(['name' => 'site_url'])->value; ?>" target="_blank">http://<?= Setting::unique(["name" => "site_url"])->value; ?></a></p>
